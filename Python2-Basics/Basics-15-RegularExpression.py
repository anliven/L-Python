...
### 获取匹配表达式
# re.match方法re.search方法可以使用group(num) 或 groups() 匹配对象函数来获取匹配表达式。
...
# python的字符串碰到"\"就会转义后面的字符,如果想显示"\",则必须要打"\\"
print "\bhi"
print r"\bhi"  # r是raw的意思,表示对字符串不进行转义
print "\\bhi"
...
##### re.match() re.search() re.sub() 示例说明

line = "Cats are smarter than dogs"
phone = "2004-959-559 # This is Phone Number"

num1 = re.sub(r'#.*$', "", phone)  # 相当于删除了#号之后的内容
num2 = re.sub(r'\D', "", phone)  # 相当于去除了所有非数字字符
print "Phone Num1:", num1, "Phone Num2:", num2

matchout = re.match(r'(.*) are (.*?) .*', line, re.M | re.I)  # re.match方法
print "  m-group():", matchout.group(), "  m-group(1):", matchout.group(1), "  m-group(2):", matchout.group(2)
searchout = re.search(r'(.*) are (.*?) .*', line, re.M | re.I)  # re.search方法
print "  s-group():", searchout.group(), "  s-group(1):", searchout.group(1), "  s-group(2):", searchout.group(2)
...
### 输出结果如下
# Phone Num1: 2004-959-559  Phone Num2: 2004959559
#   m-group(): Cats are smarter than dogs   m-group(1): Cats   m-group(2): smarter
#   s-group(): Cats are smarter than dogs   s-group(1): Cats   s-group(2): smarter
# No match!!
